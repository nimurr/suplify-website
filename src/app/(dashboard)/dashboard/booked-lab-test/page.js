...
import { useGetBookedLavTestforPatientQuery, useUpdateBookedLavTestMutation, useUpdateImageLabTestMutation } from '@/redux/fetures/BookedLavTest/BookedLavTest';
...
const Page = () => {
    ...
    const { data, isLoading, refetch } = useGetBookedLavTestforPatientQuery();
