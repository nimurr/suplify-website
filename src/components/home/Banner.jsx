  ...
  return (
    <>
      ...
      <div className="relative h-screen flex items-center justify-start">
        ...
        {/* Content */}
        <div className="z-20 md:w-[80%] w-[90%] mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              className="bg-transparent hover:bg-white/10 text-white font-bold py-3 px-6 border-2 border-white rounded transition"
            >
